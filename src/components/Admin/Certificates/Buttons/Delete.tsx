...
interface DeleteButtonProps {
   certificates: State<TAdminTableCertficateData[], {}>;
   selectable: ReturnType<typeof useSelectable<TAdminTableCertficateData>>;
}
   ...
   function deleteCertificates() {
      ...
      toast.promise(
         ...
         ),
         {
            ...
            success: `Deleted ${selected.length} certificate${
               selected.length > 1 ? 's' : ''
            }`,
