...
import { AdminMyProfileUpdateSchemaType } from './Schema';

interface AdminMyProfileUpdateDetailsProps {
   form: UseFormReturn<AdminMyProfileUpdateSchemaType, any, any>;
}

const AdminMyProfileUpdateDetails: FC<AdminMyProfileUpdateDetailsProps> = ({
   form: {
      control,
      formState: { errors },
      trigger,
...
export default AdminMyProfileUpdateDetails;
