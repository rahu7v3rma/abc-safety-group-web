...
export const AdminMyProfileUpdateSchema = z.object({
...
export type AdminMyProfileUpdateSchemaType = z.infer<
   typeof AdminMyProfileUpdateSchema
>;

export const adminMyProfileUpdateDefaultValues: AdminMyProfileUpdateSchemaType =
   {
      firstName: '',
      lastName: '',
      email: '',
