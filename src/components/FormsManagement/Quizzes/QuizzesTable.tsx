...
interface AdminQuizzesManagementProps {
...
const AdminQuizzesManagementTable: FC<AdminQuizzesManagementProps> = ({
   data,
   pagination,
   error = false,
   page,
...
export default AdminQuizzesManagementTable;
