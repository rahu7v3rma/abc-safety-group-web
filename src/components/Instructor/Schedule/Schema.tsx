...
export const InstructorScheduleTableSchema: TVisualizationTableRootSchema<TInstructorTableScheduleData> =
   {
      __root: {
         columnsOrder: [
            'courseName',
         ...
         render: (children, values) => {
            return (
               <Link
                  href={`/instructor/my-courses/course/${values.courseId}/schedule/${values.seriesNumber}`}
